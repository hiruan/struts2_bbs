	...
	<table border="1" summary="게시판 상세조회">
		...
		<tbody>
			<tr>
				...
				<td><s:property value="boardVo.subject" /></td>
			</tr>
			<tr>
				<th align="center">작성자/조회수</th>
				<td><s:property value="boardVo.writer" /> / <s:property value="boardVo.hit" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2"><s:property value="boardVo.contents" escape="false" /></td>
			</tr>
		</tbody>
	</table>
	<p class="btn_align">
