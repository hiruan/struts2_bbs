...
<body>
	...
	<table border="1" summary="게시판 수정 폼">
		...
		<tbody>
			<tr>
				...
				<td>
					<s:textfield name="subject" value="%{boardVo.subject}" size="80" maxlength="100"/>
				</td>
			</tr>
			<tr>
				<th align="center">작성자</th>
				<td>
					<s:textfield name="writer" value="%{boardVo.writer}" maxlength="20"/>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<s:textarea name="contents" cols="80" rows="10" value="%{boardVo.contents}"></s:textarea>
					<script>
	...
	<p>
		<input type="button" value="목록" onclick="goUrl('boardListAction?pageNum=${boardVo.pageNum}&amp;searchType=${boardVo.searchType}&amp;searchText=${boardModel.searchText}');" />
