...
<body>
	...
	<table border="1" summary="게시판 목록">
		...
		<tbody>
			...
			<tr>
				<td align="center"><s:number name="totalCount  - (#status.index+1)+ 1 - (boardVo.pageNum - 1) * boardVo.listCount" type="integer"  /></td>
				<td><a href="boardViewAction?num=${num}&pageNum=${pageNum}&amp;searchType=${boardVo.searchType}&amp;searchText=${boardVo.searchText}"><s:property value="subject" /></a></td>
